...
**当前阶段**：完整微服务架构，支持服务注册发现、配置中心、链路追踪、熔断降级。
...
**已完成阶段**：
1. ✅ 最简登录（sa-Token 核心模式）
2. ✅ JWT + RBAC 权限控制
3. ✅ 社区功能（帖子、评论、点赞、分类标签）
4. ✅ 聚合搜索服务（ES全文搜索、热词分析）
5. ✅ 实时消息与通知系统
6. ✅ 刷题系统
7. ✅ 后台管理系统
8. ✅ 用户行为分析
9. ✅ API Gateway 网关
10. ✅ 微服务完善（Nacos、链路追踪、熔断降级）
...
| Elasticsearch | 9201 | 全文搜索 |
| Zipkin | 9411 | 链路追踪 |
| Sentinel | 8858 | 熔断降级控制台 |
...
│   └── clx-common-observability/  # 链路追踪、熔断降级
├── clx-api/                       # Feign API
│   ├── clx-api-auth/              # 认证服务 Feign 接口
│   └── clx-api-user/              # 用户服务 Feign 接口
├── clx-gateway/                   # API 网关
├── clx-user/                      # 用户服务（当前可用）
