...
CREATE TABLE IF NOT EXISTS `group_capacity` (
    ...
    `quota` int(11) NOT NULL DEFAULT '0' COMMENT '配额',
    `usage` int(11) NOT NULL DEFAULT '0' COMMENT '使用量',
    `max_size` int(11) NOT NULL DEFAULT '0' COMMENT '单个配置大小上限',
    `max_aggr_count` int(11) NOT NULL DEFAULT '0' COMMENT '聚合子配置最大个数',
    `max_aggr_size` int(11) NOT NULL DEFAULT '0' COMMENT '单个聚合数据的子配置大小上限',
    `max_history_count` int(11) NOT NULL DEFAULT '0' COMMENT '最大变更历史数量',
    `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
    PRIMARY KEY (`id`),
...
INSERT IGNORE INTO users (username, password, enabled) VALUES ('nacos', '$2a$10$EuWPZHzz32dJ947qbHix0.j6.gdDlK4b0g6hLA9Sr1W9P3vXOIv8.', TRUE);
