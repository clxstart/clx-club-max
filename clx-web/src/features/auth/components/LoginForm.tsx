    ...
    <div className={`glass-card rounded-xl p-6 md:p-8 card-hover fade-in ${shake ? 'shake' : ''}`} translate="no">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="text-[#39ff14]/40">开发中</span>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <button type="button" className="w-10 h-10 rounded-lg border border-[#39ff14]/20 flex items-center justify-center text-[#39ff14]/50 hover:border-[#39ff14] hover:text-[#39ff14] transition-all" aria-label="网页登录">
            ...
            <button type="button" className="w-10 h-10 rounded-lg border border-[#39ff14]/20 flex items-center justify-center text-[#39ff14]/50 hover:border-[#39ff14] hover:text-[#39ff14] transition-all" aria-label="代码仓登录">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button type="button" className="w-10 h-10 rounded-lg border border-[#39ff14]/20 flex items-center justify-center text-[#39ff14]/50 hover:border-[#39ff14] hover:text-[#39ff14] transition-all" aria-label="谷歌登录">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
